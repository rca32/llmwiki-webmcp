...
Review the returned source action, page actions, topic organization action, claim count, warnings, expiry, and `plan_hash`. Applying a plan is consequential: obtain user authorization when it has not already been given for this ingest.
