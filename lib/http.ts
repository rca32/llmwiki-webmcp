...
export async function jsonBody(request:Request):Promise<unknown>{ try{return await request.json();}catch{throw new AppError('validation_error','The request body must be valid JSON.',400);} }
